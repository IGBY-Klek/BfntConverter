...
namespace Pronama.ImageSharp.Formats.Bfnt
{
    public sealed class MpnDecoder : IImageDecoder, IImageInfoDetector
    {
        ...
        public IImageInfo Identify(Configuration configuration, Stream stream) => new MpnDecoderCore(configuration).Identify(stream, default);
