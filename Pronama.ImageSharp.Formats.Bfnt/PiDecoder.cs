...
namespace Pronama.ImageSharp.Formats.Bfnt
{
    public sealed class PiDecoder : IImageDecoder, IImageInfoDetector
    {
        ...
        public IImageInfo Identify(Configuration configuration, Stream stream) => new PiDecoderCore(configuration).Identify(stream, default);
